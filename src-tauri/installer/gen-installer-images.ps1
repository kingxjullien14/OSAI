...
$bmp = $res[0]; $g = $res[1]
Add-Glow $g 18 36 150 70
$wordFont = New-Object System.Drawing.Font("Segoe UI", 34, [System.Drawing.FontStyle]::Bold)
$g.DrawString("AIOS", $wordFont, (New-Object System.Drawing.SolidBrush($accent)), (New-Object System.Drawing.PointF(13, 192)))
...
$g.DrawString("AIOS", $hFont, (New-Object System.Drawing.SolidBrush($accent)), (New-Object System.Drawing.PointF(11, 16)))
