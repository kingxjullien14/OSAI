...
test("explicit scheme passes through untouched", () => {
  ...
  assert.equal(normalizeUrl("file:///Users/osai/doc.pdf"), "file:///Users/osai/doc.pdf");
...
test("bare filesystem paths are not URL shapes today — they go to search", () => {
  ...
  assert.equal(
    normalizeUrl("/Users/osai/doc.pdf"),
    "https://www.google.com/search?q=%2FUsers%2Fosai%2Fdoc.pdf",
  );
});
